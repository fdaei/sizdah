    ...
    private function testimonials(): void
    {
        ...
        $testimonial->setTranslations([
            ...
            'fa' => [
                ...
                'quote' => 'سیزده به ما کمک کرد بازاریابی پراکنده‌مان را به سیستمی شفاف و منسجم تبدیل کنیم. برای اولین بار، محتوا، کمپین‌ها و پیام برندمان، چه در فضای آنلاین و چه در فروشگاه، هم‌راستا شده‌اند.',
