...
## Last completed unit: G37 — `About.vue` checked end to end (hero/story/principle-cards), clean; `BlogCard`/`PostMeta` clean; `ProjectPostCard` missing its `shadow-card` on the project image — fixed. G33-G37 committed (`8796bce` + this unit, not yet committed — see below).
